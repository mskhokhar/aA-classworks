...
class MinMaxStack {
    ...
    push(val) {
        ...
        if (!this.minStorage.length || this.minStorage[this.minStorage.length-1].value > val) {
            this.minStorage.push(newNode)
        }
        if (!this.maxStorage.length || this.maxStorage[this.maxStorage.length-1].value < val) {
    ...
    pop() {
        ...
        if (this.maxStorage[this.maxStorage.length - 1].value === this.top.value) {
            this.maxStorage.pop();
        }
        if (this.minStorage[this.minStorage.length - 1].value === this.top.value) {
            this.minStorage.pop();
        }
        const temp = this.top;
